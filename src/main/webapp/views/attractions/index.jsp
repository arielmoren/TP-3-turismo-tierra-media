...
<body>
    ...
    background: linear-gradient(to right, rgb(34, 32, 31), rgb(3, 22, 30)); color: rgb(240, 152, 38);">
							...
							<div class="card-body">
								...
								<div>
									<c:if test="${login.coins>=attraction.cost && login.time>=attraction.duration && attraction.capacity>=1}">
...
<!-- btn-outline-primary  la clase que tenian los botones originales -->